...
class VolumeKeyBoardInterface {
  /// Constructor for [VolumeKeyBoardInterface].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  VolumeKeyBoardInterface({BinaryMessenger? binaryMessenger})
